...
from models import RUNet as IMAGE_TRANSFER_MODEL
...
def _read_tfrecord(
    ...
    if cache: # if cacheing dataset, either to storage or memory
...
def _read_and_preprocess_dataset(
    tfrec_dir,
    batch_size, 
    image_shape, 
    n_images, 
    ...
    for ds in ["train", "valid"]:
        ...
        dataset[ds] = _read_tfrecord(
            file_pattern        = op.join(tfrec_dir, f"data-{ds}_shard-*.tfrec"), 
